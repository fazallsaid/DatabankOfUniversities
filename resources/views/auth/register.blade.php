                ...
                <div class="flex flex-col w-full  overflow-hidden relative min-h-screen radial-gradient items-center justify-center g-0 px-4">
                    ...
                    <div class="justify-center items-center w-full card lg:flex max-w-md ">
                        <div class=" w-full card-body">
                                ...
                                <p class="mb-4 text-gray-400 text-lg text-center">Contribute to Databank of Universities now.</p>
                            <!-- form -->
                            <form>
                                <!-- username -->
                                <div class="mb-4">
                                ...
                                <input type="email" id="forUsername" name="email" class="py-3 px-4 block w-full border-gray-200 rounded-sm text-sm focus:border-blue-600 focus:ring-0 " aria-describedby="hs-input-helper-text">
                                </div>
                                <div class="mb-4">
                                    <label for="forUsername"
                                    class="block text-sm mb-2 text-gray-400">Nama Depan</label>
                                <input type="text" id="forUsername" name="email" class="py-3 px-4 block w-full border-gray-200 rounded-sm text-sm focus:border-blue-600 focus:ring-0 " aria-describedby="hs-input-helper-text">
                                </div>
                                <!-- password -->
                                <div class="mb-6">
